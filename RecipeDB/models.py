...
# # I will create a user model later
# # Idea is to implement a application where we can generate grocesary shopping list by selecting the recipes selected.
# # a user model that stores data like have they tried the recipe and randomly suggest a recipe to try etc...
